...
namespace Dokkaebi.Core.Networking
{
    ...
    public class GameStateManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (networkManager == null) networkManager = FindFirstObjectByType<NetworkingManager>();
            ...
            // if (vfxManager == null) vfxManager = FindFirstObjectByType<VFXManager>(); // Temporarily commented out until VFXManager is implemented
            // if (audioManager == null) audioManager = FindFirstObjectByType<AudioManager>(); // Temporarily commented out until AudioManager is implemented
